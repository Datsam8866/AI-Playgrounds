...
> 最後更新：2026-08-18（補同步至 2026-08-11 記帳資料）
...
| --- | --- |
| 總交易筆數 | 1,493 筆 |
| 資料時間範圍 | 2024-11-25 至 2026-08-11 |
| 來源 | 3 份 Excel，19 個 sheet + 即時記帳 |
| 主交易表 | `transactions` |
...
- **Overview**：全期 KPI（總收入/支出/淨額/月均）、收入/支出面積趨勢圖、淺色系不同半徑累計支出圓餅圖（圖內百分率 + 右側占比與金額分布）、2024/2025/2026 年度對比表
- **Monthly**：月份篩選、資料範圍切換、月收入/支出/淨額 KPI、近 12 個月收入/支出面積趨勢、淺色系不同半徑本月支出與付款人支出圓餅圖（圖內百分率 + 右側占比與金額分布）、大筆支出 Top 10、交易明細
- **Sam & Rita**：比例輸入（互鎖，預設 50/50）、扣除各自當月收入後即時結算、分類分攤明細、localStorage 記住比例
...
| 月份 | TWD 淨額 | 月份 | TWD 淨額 |
| --- | ---: | --- | ---: |
| 2024-11 | -1,313 | 2025-10 | -9,228 |
| 2024-12 | -172,370 | 2025-11 | -21,023 |
| 2025-01 | -144,991 | 2025-12 | -17,406 |
| 2025-02 | -65,233 | 2026-01 | -94,176 |
| 2025-03 | +10,944 | 2026-02 | -6,041 |
| 2025-04 | -57,787 | 2026-03 | -18,820 |
| 2025-05 | -33,323 | 2026-04 | -13,750 |
| 2025-06 | -62,098 | 2026-05 | -89,409 |
| 2025-07 | -12,620 | 2026-06 | -16,624 |
| 2025-08 | -58,396 | 2026-07 | -59,246 |
| 2025-09 | -37,059 | 2026-08 | -52,067 |
