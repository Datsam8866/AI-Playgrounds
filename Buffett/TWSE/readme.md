...
Snapshot date：2026-04-17（更新於 2026-05-10）
...
- `Utility = 3.445` ｜ `Sharpe = 0.707`
- `P(portfolio > 0050) = 70.25%` ｜ `P(portfolio < 0) = 20.45%`
- `turnover = 28.0%`

配置異動（vs 上次 5/8）：新增 `2383` 台光電、`2467` 志聖；移除 `3037` 欣興、`2360` 致茂。
