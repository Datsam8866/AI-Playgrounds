...
| --- | ---: | ---: | ---: | ---: |
| `VOO` | 258 | 660.12 | 170,311 | 58.5% |
| `INTC` | 173 | 95.78 | 16,570 | 5.69% |
| `SNDK` | 11 | 1,255.86 | 13,814 | 4.75% |
| `AMD` | 40 | 341.54 | 13,662 | 4.69% |
| `ARM` | 60 | 203.26 | 12,196 | 4.19% |
| `AVGO` | 29 | 416.50 | 12,079 | 4.15% |
| `NVDA` | 58 | 198.48 | 11,512 | 3.96% |
| `TSM` | 27 | 401.61 | 10,843 | 3.73% |
| `LITE` | 11 | 976.18 | 10,738 | 3.69% |
| `COHR` | 30 | 329.89 | 9,897 | 3.40% |
| `TSLA` | 24 | 392.51 | 9,420 | 3.24% |
| **合計** | | | **291,041** | **100%** |

與模型配置差異（模型 vs 實際）：
- 模型有、實際**未持有**：無
- 實際有、模型**未推薦**：AMD、ARM、AVGO、COHR、INTC、NVDA、TSLA、TSM
- VOO 實際 58.5%，低於模型建議 92.3%
...
> ⚠️ **Regime 警示**：截面由 `risk_on`（4/14）轉為 `caution`（5/1）。最新模型配置為 VOO 92.3%、SNDK 3.8%、LITE 3.8%，beta 1.161 低於 caution 上限 1.20（`feasible` 模式）。
